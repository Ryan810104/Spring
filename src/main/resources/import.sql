...
insert into customer_Message_Board(customermessageboard_article_floor,customermessageboard_memberid,customermessageboard_message,customermessageboard_messagetime,customermessageboard_response_floor,customermessageboard_status,customermessageboard_title,customermessageboard_member_num) values (7,'Ogushi','嘴臭仔Sally滾辣，小心生兒子沒闢演',getdate(),0,1,'不爽不要玩',7);
insert into customer_Message_Board(customermessageboard_article_floor,customermessageboard_memberid,customermessageboard_message,customermessageboard_messagetime,customermessageboard_response_floor,customermessageboard_status,customermessageboard_title,customermessageboard_member_num) values (8,'Ogushi','旺八彈為什麼隱藏我留言',getdate(),0,1,'辣雞網站',7);
...
insert into complaint(complaint_message,complaint_messagetime,complaint_response,complaint_status,complaint_type,member_id,cmb_num,complaint_picurl) values ('文章編號:7	(勿更改以利查證)',getdate(),null,0,4,'Sally',7,'/resources/complaintPhoto/complaintArticleNum8.png');
