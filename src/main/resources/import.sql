...
insert into customer_Message_Board(customermessageboard_article_floor,customermessageboard_memberid,customermessageboard_message,customermessageboard_messagetime,customermessageboard_response_floor,customermessageboard_status,customermessageboard_title,customermessageboard_member_num) values (16,'Ogushi','嘴臭仔Sally，暴龍怎麼可能會贏',getdate(),0,1,'暴龍一定輸到脫褲^^',7);
insert into customer_Message_Board(customermessageboard_article_floor,customermessageboard_memberid,customermessageboard_message,customermessageboard_messagetime,customermessageboard_response_floor,customermessageboard_status,customermessageboard_title,customermessageboard_member_num) values (17,'Ogushi','趕羚羊~~祝你們全部輸錢辣~~',getdate(),0,1,'fuuukyou~~',7);
insert into customer_Message_Board(customermessageboard_article_floor,customermessageboard_memberid,customermessageboard_message,customermessageboard_messagetime,customermessageboard_response_floor,customermessageboard_status,customermessageboard_title,customermessageboard_member_num) values (18,'Ogushi','幹嘛隱藏我留言，管理員蝦啦',getdate(),0,1,'辣雞網站',7);
...
insert into complaint(complaint_message,complaint_messagetime,complaint_response,complaint_status,complaint_type,member_id,cmb_num,complaint_picurl) values ('文章編號:16	(勿更改以利查證)',getdate(),null,0,4,'Sally',17,'/resources/complaintPhoto/complaintArticleNum16.png');
...
insert into complaint(complaint_message,complaint_messagetime,complaint_response,complaint_status,complaint_type,member_id,cmb_num,complaint_picurl) values ('文章編號:17	(勿更改以利查證)',getdate(),null,0,4,'Sally',16,'/resources/complaintPhoto/complaintArticleNum17.png');
...
/*fake data*/
insert into member(member_id,member_password,member_permission,member_email,member_phonenum,create_time,member_viplevel,member_photo,money_balance,member_photourl,member_nick_name,member_fitst_name,member_last_name,member_location) values('Sally','123',0,'sally@gmail.com','0987-654-321',getdate(),1,null,500,'/resources/memberPhoto/sally.jpg','莎莉','Sally','Michaela','Taipei');
insert into member(member_id,member_password,member_permission,member_email,member_phonenum,create_time,member_viplevel,member_photo,money_balance,member_photourl,member_nick_name,member_fitst_name,member_last_name,member_location) values('Mike','123',0,'mike@gmail.com','0123456789',getdate(),1,null,3504,'/resources/memberPhoto/mike.jpg','麥克','Mike','Smith','Taipei');
insert into member(member_id,member_password,member_permission,member_email,member_phonenum,create_time,member_viplevel,member_photo,money_balance,member_photourl,member_nick_name,member_fitst_name,member_last_name,member_location) values('Ogushi','123',0,'Ogushi@gmail.com','0123456789',getdate(),1,null,400,'/resources/memberPhoto/Ogushi.png','奧斯','Ogushi','Jones','Taipei');
insert into member(member_id,member_password,member_permission,member_email,member_phonenum,create_time,member_viplevel,member_photo,money_balance,member_photourl,member_nick_name,member_fitst_name,member_last_name,member_location) values('Udo','123',0,'Udo@gmail.com','0123456789',getdate(),2,null,7,'/resources/memberPhoto/udo.jpg','約督','Udo','Williams','Taipei');
insert into member(member_id,member_password,member_permission,member_email,member_phonenum,create_time,member_viplevel,member_photo,money_balance,member_photourl,member_nick_name,member_fitst_name,member_last_name,member_location) values('Sam','123',0,'Sam@gmail.com','0123456789',getdate(),2,null,744,'/resources/memberPhoto/sam.jpg','山姆','Sam','Taylor','Taipei');
insert into member(member_id,member_password,member_permission,member_email,member_phonenum,create_time,member_viplevel,member_photo,money_balance,member_photourl,member_nick_name,member_fitst_name,member_last_name,member_location) values('John','123',0,'John@gmail.com','0123456789',getdate(),1,null,744,'/resources/memberPhoto/John.jpg','強','John','Brown','Taipei');
