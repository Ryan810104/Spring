					...
					<div class="panel panel-white post panel-shadow">
						...
						<div class="post-description">
							...
							<div class="stats">
								...
								<!-- 								</a> -->
								<button>
									<i class="fa fa-thumbs-up icon" style="font-size: 17px"></i><span
										style="font-size: 17px">2</span>
								</button>
								...
								<button>
									<i class="fas fa-comment-dots" id="messageorder"
										style="font-size: 20px"><span style="font-size: 20px">&nbsp&nbsp留言</span></i>
								</button>
							</div>
						</div>
						<div class="post-footer" id="messageorder1">
							<div class="input-group" id="messageorder11">
								<input class="form-control" placeholder="Add a comment"
									type="text" id="commentcontent"> <span
									class="input-group-addon">
									<button id="comment">
										<i class="fa fa-edit"></i>
									</button> <input type="text" id="articlefloor" style="display: none"
									value="1">
								</span>
							</div>
							<div id="test">
								...
								.ajax({
									...
									success : function(data) {
										...
										for (var i = 0; i < data.length; i++) {
											...
											txt += "$(\"#floor"
													+ i
													+ "\").click(function(){$(\"#\"+this.id+\"1\").toggle(1000);})"
											txt += "<\/script>"
											...
											txt += "$(\"#articlefloor"
													...
													+ i
													+ "1\").val(),CustomermessageboardMemberid : $(\"#CustomermessageboardMemberid\").val(),CustomermessageboardStatus : 1,},success : function() {$(\"#leavecontentarea"
													+ i
													+ "\").val('');alert(\"已傳送成功\");}})});"
