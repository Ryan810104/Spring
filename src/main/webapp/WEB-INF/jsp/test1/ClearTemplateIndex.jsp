...
<jsp:include page="/WEB-INF/jsp/fragment/main-sidebar.jsp"></jsp:include>
		...
		<div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='moneyRecordMemberNum' name="moneyRecordMemberNum"
						type="text" 
						placeholder="moneyRecordMemberNum:" class="form-control" onclick="this.value=''">
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='moneyRecordPoint' name="moneyRecordPoint" type="text"
						value="${sessionScope.member.memberNum}" placeholder="moneyRecordPoint:"
						class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='moneyRecordChiptype' name="moneyRecordChiptype" type="text"
						value="${memberP.moneyRecordChip}" placeholder="moneyRecordChiptype:"
						class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='chipMemberNum' name="chipMemberNum"
			...
			<div class="form-group row">
				<div class="btn-group">
					...
					<button class="btn btn-lg btn-primary" type="button" id="insert33">insert</button>
					<button class="btn btn-lg btn-primary" type="button" onclick="getAndsetVal();">click</button>
					<button class="btn btn-lg btn-primary" type="button" onclick="calculate();">換點數</button>
	...
	<script
		...
		function getAndsetVal(){
			...
			document.getElementById('chipMemberNum').value = tt-5;
	...
	<script>
		$("#insert33").click(
				function() {
					...
					$.ajax({
						url : '/admin/memberBeans/insert1?moneyRecordMemberNum='
