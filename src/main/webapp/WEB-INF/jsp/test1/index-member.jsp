	...
	<form class="form-signin" name="form1" id="form1" action=""
		...
		<div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='moneyRecordMemberid' name="moneyRecordMemberid"
						type="text" value="${memberP.moneyRecordMemberid}"
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='moneyRecordcash' name="moneyRecordcash" type="text"
						value="${memberP.moneyRecordcash}" placeholder="moneyRecordcash:"
						class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='chipRecordMemberid' name="chipRecordMemberid"
						type="text" value="${memberP.chipRecordMemberid}"
						placeholder="Member Id:" class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='chipRecordChip' name="chipRecordChip" type="text"
						value="${memberP.chipRecordChip}" placeholder="chipRecordChip:"
						class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
	...
	<script>
		$("#insert1").click(
				function() {
					...
					$.ajax({
						url : '/admin/memberBeans/insert2?moneyRecordMemberid='
								+ $("#moneyRecordMemberid").val()
								+ "&moneyRecordcash="
								+ $("#moneyRecordcash").val()
								+ "&moneyRecordChip="
								+ $("#moneyRecordChip").val()
								+ "&chipRecordMemberid="
								+ $("#chipRecordMemberid").val()
								+ "&chipRecordChip="
								+ $("#chipRecordChip").val(),
						method : 'POST',
