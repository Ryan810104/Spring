...
<jsp:include page="/WEB-INF/jsp/fragment/main-sidebar.jsp"></jsp:include>
		...
		<div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='chipRecordMemberNum' name="chipRecordMemberNum" type="text"
						 placeholder="chipRecordMemberNum:"
						class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
	...
	<script
		...
		function getAndsetVal(){
			...
			document.getElementById('chipRecordMemberNum').value = tt;
			 ...
			 var aa = document.getElementById('round').value;
			 document.getElementById('chipRecordRound').value = aa; 
		}
