...
<body class="text-center">
	<form class="form-signin" name="form1" id="form1" action=""
		...
		<div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='productImageUrl' name="productImageUrl" type="text"
						placeholder="productImageUrl:" class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='confirmUrl' name="confirmUrl" type="text"
						placeholder="confirmUrl:" class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='orderId' name="orderId" type="text"
						placeholder="orderId:" class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='oneTimeKey' name="oneTimeKey" type="text"
						placeholder="oneTimeKey:" class="form-control">
					<div>${ErrorMsg.highwayName}</div>
				</div>
			</div>
	...
	<script>
		$("#insert1").click(
				function() {
					...
					alert(ant);
					$.ajax({
						url : "/admin/memberBeans/linereserve?amount="
								+ $("#amount").val() + "&productImageUrl="
								+ $("#productImageUrl").val()
								+"&productName="
								+$("#productName").val()
								+"&orderId="
						...
						type : 'POST',
						// 						headers: {
						// 					        'X-LINE-ChannelId':'1597147674',
						// 					        'X-LINE-ChannelSecret':'b4f5f78a87aae3e95da033417226b89f',
						// 					        'Content-Type':'application/json;charset=UTF-8'
						// 					    },
						// 						XLINEChannelId:'{}',
						// 						XLINEChannelSecretKey:'{}',
