	...
	<form class="form-signin" name="form1" id="form1" action=""
		...
		<div>
			...
			<div class="form-group row">
				<div class="col-sm-12">
					<input id='phone' name="chipMemberid" type="text" value="${memberP.chipMemberid}"
		...
		$("#insert1").click(function() {
			...
			$.ajax({
				...
				success : function(ajaxres) {
					...
					$(location).attr("href", "/admin/chip/list");
...
//  			data:{id1:$('#id1'), id2:$('#id2')},
			success:function(data){
				...
				$(location).attr("href","/admin/member/list?id1="+$('#id1').val()+"&id2="+$('#id2').val());
			},
		     error:function(data){
		    	 alert("資料搜尋失敗");
		     }
