	...
	<script>
		$
				.ajax({
					...
					url : "/admin/chiprecord/query",
					type : "POST",
					success : function(data) {
						var str = "";
						$("#showdata")
								.append(
										"<thead><tr><th>chipRecordNum</th><th>chipRecordMemberid</th><th>chipRecordRecord</th><th>chipRecordTime</th></tr></thead>");
						str += "<tbody>";
						$
								.each(
										data,
		...
		function edit(Object) {
			...
			window.location.href = "/admin/chiprecord/index?chipRecordNum=" + Object.id;

			
		}
		function del(Object) {
			$(location).attr('href','/admin/chiprecord/index?chipRecordNum='+ Object.id);
		}
	</script>
